    ...
    <>
      ...
      <section className="section">
        ...
        <div className="stack">
          ...
          <Alert variant="warning" title="Warning">
            Please check the data before continuing.
          </Alert>
          <Alert variant="danger" title="Error">
            Something went wrong. Please try again.
          </Alert>
          <Alert variant="success">Deploy completed 2 minutes ago.</Alert>
          <Alert variant="danger" title="Deploy failed" fullWidth>
      ...
      <section className="section">
        ...
        <Card>
          ...
          <Card.Content>
            Card content. Combine with any component — buttons, forms, text.
          </Card.Content>
          <Card.Footer>
